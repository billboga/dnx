...
namespace Microsoft.Dnx.Runtime
{
    public class DefaultHost : IDisposable
    {
        ...
        private readonly ICompilationEngineFactory _compilationEngine;
        private ICompilationEngine _compilationSession;
        ...
        public DefaultHost(RuntimeOptions options,
                           ...
                           ICompilationEngineFactory compilationEngine)
        {
...
{runtimeFrameworkInfo}";
        ...
        private void Initialize(RuntimeOptions options, IServiceProvider hostServices, IAssemblyLoadContextAccessor loadContextAccessor)
        {
            ...
            _compilationSession = _compilationEngine.CreateEngine(
